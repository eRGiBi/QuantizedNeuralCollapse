...
class ResNetish(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, input_channels=3):
        ...
        # This is the feature extractor before the final classification head.
        self.penultimate = nn.Linear(256 * 4, 128) # Feature dimension = 128
    ...
    def forward(self, x):
        ...
        penultimate_features = self.penultimate(out)
