...
from training.accumulators import DecAccumulator
from collapse_analysis.kernels import class_dist_norm_vars
from collapse_analysis.util import normalize, symm_reduce
...
def clf_ncc_agreement(
    ...
    nearest-class center (NCC) classifiers: percentage of hits over Ns samples.
